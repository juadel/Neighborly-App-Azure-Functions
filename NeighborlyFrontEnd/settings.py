#--------- Flask settings
SERVER_HOST = 'https://juadel-neighborly-client.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 8000
...
API_URL = "https://juadel-neighborly.azurewebsites.net/api"
